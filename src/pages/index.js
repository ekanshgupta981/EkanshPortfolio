...
export default function Main() {
  ...
  let testTimer = setTimeout(() => setTime(true), 5000);
  useEffect(() => {
    testTimer;
  }, []);
  return (
    <>
      {time === false ? (
        ...
        <div>
            ...
            <div className="d-flex justify-content-center flex-column align-items-center">
              ...
              <div className="d-lg-flex d-flex flex-column flex-lg-row justify-content-between  mt-lg-5 mt-3 align-items-center">
                <h4 className="text-white text-lg-start text-center font-style-new col-lg-6">
                  <p>
                    As a <span className="text-warning">MERN</span> Stack
                    Developer, I specialize in building fast and scalable web
                    applications using
                  ...
                  <p>
                    ...
                    , and{" "}
                    <span className="text-warning"> easy to maintain</span>.
                  </p>
                  <p>
                    With <span className="text-warning">MERN</span> , I can
                    develop a web application from
                    <span className="text-warning mx-2">scratch</span> , taking
                    care of the entire development process, from the
                    <span className="text-warning ms-2">server-side</span> to
                    the
          ...
          >
            <div>
              <h2 className="text-white border-bottom border-warning">
                Skills
              </h2>
            </div>
                ...
                <div className="certificates-img img-fluid ">
                  <div className="certificates-JS h-100 position-relative">
                    <div className="position-absolute cert-btn w-100">
                      <div className="card-sec pt-3 d-flex justify-content-evenly">
                        <a
                          href="./pdf/js-cert.pdf"
                          download="./pdf/js-cert.pdf"
                        >
                          <button className="btn btn-warning ">
                            Download <i className="ms-1 bi bi-download"></i>
                          </button>
              ...
              {site === 1 ? (
                <div className="d-flex justify-content-evenly col-12 project-sec flex-wrap">
                  <div className="border project-container mt-3 p-1 pb-3 d-flex flex-column align-items-center">
                    ...
                    <div className="d-flex pt-4 justify-content-between col-lg-9 col-10">
                      <a
                        href="https://caffelatte-1.netlify.app"
                        target="_blank"
                      >
                    ...
                    <div classname="">
                      <h5 className="font-style-poppins text-white pt-4 text-center ">
                        This is Desktop view of cafe shop website which is made
                  ...
                  <div className="border project-container mt-3 p-1 pb-3 d-flex flex-column align-items-center">
                    ...
                    <div classname="">
                      <h5 className="font-style-poppins text-white pt-4 text-center ">
                        This is Desktop view of Flipkart group project website
                        which is made with Mern technology and have backend and
                  ...
                  <div className="border project-container mt-3 p-1 pb-3 d-flex flex-column align-items-center">
                    ...
                    <div className="d-flex pt-4 justify-content-between col-lg-9 col-10">
                      <a
                        href="https://zomato-clone-2.netlify.app/"
                        target="_blank"
                      >
                        <button className="px-4 fw-bold btn btn-light">
                          Go to site
                    ...
                    <div classname="">
                      <h5 className="font-style-poppins text-white pt-4 text-center ">
                        This is Desktop view of Zomato project website which is
                        made with Mern technology and have backend and frontend
                ...
                <div className="d-flex justify-content-evenly col-12 project-sec flex-wrap">
                  <div className="border project-container mt-3 p-1 pb-3 d-flex flex-column align-items-center">
                    ...
                    <div classname="">
                      <h5 className="font-style-poppins text-white pt-4 text-center ">
                        This is Mobile view of cafe shop website which is made
                        with Mern technology and have backend and frontend
                        programming.
                      </h5>
                    </div>
                  ...
                  <div className="border project-container mt-3 p-1 pb-3 d-flex flex-column align-items-center">
                    ...
                    <div classname="">
                      <h5 className="font-style-poppins text-white pt-4 text-center ">
                        This is Mobile view of Flipkart Group project website
                        which is made with Mern technology and have backend and
                        frontend programming.
                      </h5>
                    </div>
        ...
        <div>
          ...
          ></i>
                ...
                <a
                  href="https://api.whatsapp.com/send?phone=917719964183"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div>
                    ...
                    <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                      <h6 className="text-uppercase fw-bold mb-4">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="font-style-new mt-1">
                            Ekansh Gupta
                          </div>
                        </div>
                      </h6>
                      <p>
                        "I am a proficient MERN Stack Web Developer, dedicated
                        to crafting top-notch web applications with efficient
                        coding skills and a keen eye for design."
                      </p>
                    </div>
